...
var font = function(document, id, fontBuffer, family) {
  ...
  this.font = fontkit.create(fontBuffer);
...
font.prototype.layoutRun = function(text, features) {
...
font.prototype.layoutCached = function(text) {
  if (!this.layoutCache) {
...
font.prototype.layout = function(text, features, onlyWidth) {
...
font.prototype.encode = function(text, features) {
  var { glyphs, positions } = this.layout(text, features);
...
font.prototype.widthOfString = function(string, size, features) {

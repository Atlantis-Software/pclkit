module.exports = {
  ...
  _normalizeOpacity: function(opacity) {
  ...
  fillColor: function(color, opacity) {
    ...
    if (color) {
        opacity = this._normalizeOpacity(opacity);
  ...
  strokeColor: function(color, opacity) {
    ...
    if (color) {
        opacity = this._normalizeOpacity(opacity);
        this._strokeColor = [color, opacity];
    }
    return this;
  },
  ...
  opacity: function(opacity) {
    if (opacity) {
      opacity = this._normalizeOpacity(opacity);
      this._fillColor[1] = opacity;
      this._strokeColor[1] = opacity;
    }
  },
